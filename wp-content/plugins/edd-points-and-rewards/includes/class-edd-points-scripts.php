...
class EDD_Points_Scripts{
	...
	public function edd_points_admin_styles( $hook_suffix ) {
		...
		$edd_screen_id		= edd_points_get_edd_screen_id();

		$page_screen_id 	= isset($current_screen->id) ? $current_screen->id : '';
		$pages_hook_suffix 	= array( 'users.php', $edd_screen_id.'_page_edd-points-log', 'profile.php' );
	...
	public function edd_points_admin_scripts( $hook_suffix ) {
		...
		$pages_hook_suffix 	= array( 'users.php', $edd_screen_id.'_page_edd-points-log', 'post.php', 'post-new.php' );
