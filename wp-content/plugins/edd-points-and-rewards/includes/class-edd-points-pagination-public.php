...
class EDD_Points_Pagination_Public{
		...
		function __construct( $ajaxpagination = 'edd_points_ajax_pagination' ) {
			$this->nextT = __("Next",'eddpoints');
			$this->prevT = __("Previous",'eddpoints');
				...
				*/
				if($lastpage > 1){
						...
						if($this->page){
								...
								//anterior button
								if($this->page > 1)
										$this->pagination .= "<a class='page-numbers1 prev' href=\"".$this->get_pagenum_link($prev)."\"  onclick = \"return $this->ajaxpagination('".$prev."')\">$p</a>";
									else
						...
						if($this->page){
								...
								if ($this->page < $counter - 1)
										$this->pagination .= "<a class='page-numbers1 next' href=\"".$this->get_pagenum_link($next)."\" onclick = \"return $this->ajaxpagination('".$next."')\" >$n</a>";
									else
