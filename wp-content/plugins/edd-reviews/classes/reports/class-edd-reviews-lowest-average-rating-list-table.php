<?php
/**
 * Lowest Average Rating List Table.
 *
 * @package    EDD_Reviews
...
/**
 * EDD_Reviews_Lowest_Average_Rating_List_Table Class
 *
 * Renders the Lowest Average Rating table on the Reports page.
 *
 * @since 2.1
 *
 * @see EDD_Reviews_Reports_List_Table
 */
class EDD_Reviews_Lowest_Average_Rating_List_Table extends EDD_Reviews_Reports_List_Table {
	/**
