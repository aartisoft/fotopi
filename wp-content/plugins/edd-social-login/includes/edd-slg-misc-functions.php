...
function edd_gp_redirect_url_notice_callback($args)
{
	...
	echo '<p style="background: #eeeeee; padding: 4px 10px 7px !important; border: 1px solid #e0e0e0;">Note: Before using the Google Plus social login, update the <strong>Authorized JavaScript origins</strong> in Google App setting, as mentioned in the document <a href="https://wpweb.co.in/documents/social-network-integration/google/#google-javascript-origins" target="_blank">here</a>.</p>';
}
