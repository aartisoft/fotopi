	  ...
	  public function edd_slg_settings( $settings ) {
		...
		$edd_slg_settings = array(
				...
				array(
					...
					'name'		=> __( 'Display Social Login buttons on:', 'eddslg' ),
					'type'		=> 'multicheck',
							...
							'edd_register'  => __( 'Check this box to add social login buttons on Easy Digital Downloads register page.', 'eddslg' ),
							...
							'wp_register'   => __( 'Check this box to add social login buttons on default WordPress register page.', 'eddslg' ),
						)
					)
				),
				array(
				...
				array(
					...
					'name'	=> __( 'Caching:', 'eddslg' ),
					'desc'	=> __( 'Check this box, if you use a caching plugin.', 'eddslg' ),
					'type'	=> 'checkbox'
				),
				...
				array(
					...
					'name'	=> __( 'Facebook Valid OAuth Redirect URL:', 'eddslg' ),
					'desc'	=> '',
				...
				array(
					...
					'name'	=> __( 'Google+ JavaScript origins URL:', 'eddslg' ),
					'desc'	=> '',
