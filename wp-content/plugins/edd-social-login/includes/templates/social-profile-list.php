				...
				<tr>
					...
					<td data-title="<?php __( 'Provider', 'eddslg' ); ?>">
						<div class="edd-slg-provider <?php echo $profile; ?>">
							<span class="edd-slg-provider-icon"><img src="<?php echo $provider_icon; ?>"></span><span class="edd-slg-provider-name"><?php echo $profile; ?></span>
						</div>
					</td>
					...
					<td><?php
						if( $profile != $primary_social ) {?>
							...
							?></a><?php 
								...
								echo __( 'Unlink primary account', 'eddslg' );
								?></a><?php
							}
						?></td>
				</tr><?php
