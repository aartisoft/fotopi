...
class EDD_Message_Log_Table extends WP_List_Table {
	 ...
	 * @return string
	 */
	public function column_sent_by( $item ) {
	...
	public function column_message( $item ) {
		...
		return "<button type=\"button\" class=\"button\" data-log-view-message data-log-id=\"$item[ID]\">"
		       . __( 'View', 'edd-message' )
		       . '</button>';
	}

	/**
	 * Outputs the delete column.
	 *
	 * @since {{VERSION}}
	 * @access private
	 *
	...
	public function column_delete( $item ) {
		...
		return "<button type=\"button\" class=\"edd-message-delete-log button\" data-log-delete data-log-id=\"$item[ID]\">"
		       . __( 'Delete', 'edd-message' )
		       . '</button>';
	}
	...
	public function get_columns() {
		$columns = array(
			...
			'message'   => __( 'Message', 'edd-message' ),
